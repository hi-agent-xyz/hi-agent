...
// posted clip). Used to *listen in* on the conversation's audio (e.g. the inspector).
//
...
/**
 * Observe the live audio bytes on this conversation. Each `GET /api/in/audio` response
