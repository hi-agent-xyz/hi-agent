// Built-in: 学会的本事 — the workshop notes a working session leaves behind so the next
// one starts ahead. They are plain .md under `skills/`, with the factory seeds in
// `skills/_builtin/` rewritten every boot.
//
