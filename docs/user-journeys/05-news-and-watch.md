...
- 🔴 **这一问先被上游故障吞了 10 小时半。** 09:57:37 发出,当时 scene 卡在 `Pause`(前一天 38 分钟的真实 402 留下的),**一个 turn 都没驱动**。人这边看到的只有屏上一块 outage view,文字通道零输出。10:02:45 重启进程,**第一个 turn 就成功了**——额度一直是好的。见 [gaps.md #21](gaps.md)。
